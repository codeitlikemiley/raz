...
"#,
        ...
        let all_lib_targets = finder
            .find_targets_for_file(&lib_rs, workspace_root)
            .unwrap();
        ...
        let test_target = finder
            .find_runnable_target(&lib_rs, workspace_root, Some(BazelTargetKind::Test))
            .unwrap();
        ...
        let binary_target = finder
            .find_runnable_target(&main_rs, workspace_root, Some(BazelTargetKind::Binary))
            .unwrap();
        ...
        let doc_test_target = finder
            .find_doc_test_target(&lib_rs, workspace_root)
            .unwrap();
        ...
        let integration_target = finder
            .find_integration_test_target(&integration_test, workspace_root)
            .unwrap();
